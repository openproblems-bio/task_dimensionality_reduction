...
meta = [
  ...
  "description" : "PyMDE is a Python implementation of Minimum-Distortion Embedding. It is a\nnon-linear method that preserves distances between cells or neighbourhoods\nin the original space.\n",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_dimensionality_reduction/task_dimensionality_reduction/src/methods/pymde/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/pymde",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_dimensionality_reduction/methods/pymde",
