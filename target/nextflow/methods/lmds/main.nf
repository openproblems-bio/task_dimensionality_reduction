...
meta = [
  ...
  "description" : "Landmark Multi-Dimensional Scaling (LMDS) is a non-linear method for\ndimensionality reduction that is based on the concept of multi-dimensional\nscaling.\n",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_dimensionality_reduction/task_dimensionality_reduction/src/methods/lmds/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_dimensionality_reduction/methods/lmds",
