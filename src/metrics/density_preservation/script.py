...
def compute_density_preservation(
    ...
    ro = _calculate_radii(high_dim, n_neighbors=n_neighbors, random_state=random_state)

    print("Compute local radii of embedding", flush=True)
    re = _calculate_radii(X_emb, n_neighbors=n_neighbors, random_state=random_state)
