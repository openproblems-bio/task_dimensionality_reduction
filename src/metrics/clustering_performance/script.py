...
# Perform Leiden clustering on dimensionality reduction embedding
n = 20
...
for res in resolutions:
    ...
    score = normalized_mutual_info_score(
        input_solution.obs["cell_type"],
        input_embedding.obs[key_added],
        average_method=par["nmi_avg_method"],
    )
